odoo.define("ssi_school_incident.school_incident_weekly_review_cancel_tour", function (
    require
) {
    "use strict";
    ...
    tour.register(
        ...
        [
            ...
            // Flow 2 — Open the Weekly Case Review record to
            // cancel.
            {
                content: "Open the record to cancel",
                trigger:
                    ".o_data_row:contains(School For Weekly Review Cancel Tour) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
            ...
            // its `name` attribute is a numeric action id in the
            // DOM; target it by label instead (patterns.md §H /
            // selectors.md §4).
            {
            ...
            // its label text. 14.0: do NOT prefix the trigger with
            // `.modal` (patterns.md §H).
            {
                content: "Select the Cancellation Reason",
                trigger:
                    ".o_field_widget[name='cancel_reason_id'] .o_radio_item:contains(Tour Weekly Review Cancel Reason) input",
                in_modal: true,
            },
            ...
            // confirm="Are you sure?" (base_select_cancel_reason_
            // views.xml:24), stacking a second modal on top of the
            // wizard; 14.0 scopes the trigger search to the
            // topmost visible modal.
            {
