odoo.define("ssi_school_incident.school_incident_approve_tour", function (require) {
    "use strict";
    ...
    tour.register(
        ...
        [
            ...
            // Flow 2 — Open the School Incident record to approve.
            {
                content: "Open the record to approve",
                trigger:
                    ".o_data_row:contains(Student For Approve Tour) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
