odoo.define("ssi_school_incident.school_incident_finish_tour", function (require) {
    "use strict";
    ...
    tour.register(
        ...
        [
            ...
            // Flow 2 — Open the School Incident record to finish.
            {
                content: "Open the record to finish",
                trigger:
                    ".o_data_row:contains(Student For Finish Tour) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
