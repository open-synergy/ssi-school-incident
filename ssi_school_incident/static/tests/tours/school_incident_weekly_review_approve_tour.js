odoo.define("ssi_school_incident.school_incident_weekly_review_approve_tour", function (
    require
) {
    "use strict";
    ...
    tour.register(
        ...
        [
            ...
            // approve.
            {
                ...
                trigger:
                    ".o_data_row:contains(School For Weekly Review Approve Tour) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
            ...
            {
                // Post-Condition: status automatically moves to
                // Done -- this model has no separate Open state.
