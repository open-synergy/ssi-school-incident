odoo.define("ssi_school_incident.school_incident_weekly_review_confirm_tour", function (
    require
) {
    "use strict";
    ...
    tour.register(
        ...
        [
            ...
            // Flow 2 — Open the Weekly Case Review record to confirm.
            {
                content: "Open the record to confirm",
                trigger:
                    ".o_data_row:contains(School For Weekly Review Confirm Tour) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
