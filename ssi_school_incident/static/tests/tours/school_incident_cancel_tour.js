odoo.define("ssi_school_incident.school_incident_cancel_tour", function (require) {
    "use strict";
    ...
    tour.register(
        ...
        [
            ...
            // Flow 2 — Open the School Incident record to cancel.
            {
                content: "Open the record to cancel",
                trigger:
                    ".o_data_row:contains(Student For Cancel Tour) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
